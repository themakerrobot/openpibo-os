...
![image-20210820110653606](.images/processtest.png)
...
- **oled** : OLED 패널을 테스트합니다.
  ...
  ![image-20210907145853637](.images/image-20210907145853637.png)
...
- **mic** : 마이크를 테스트합니다.
  ...
  1. 5초간 음성을 녹음합니다.
     ...
     ![image-20210907141722024](.images/image-20210907141722024.png)
...
- **camera** : 카메라를 테스트합니다.
  ...
  ![image-20210907150123624](.images/image-20210907150123624.png)
...
- **neopixel** : LED (파이보 눈) 를 테스트합니다.
  ...
  ![image-20210907150306438](.images/image-20210907150306438.png)
...
- **pir** : PIR 센서를 테스트합니다.
  ...
  ![image-20210907143454951](.images/image-20210907143454951.png)
...
- **touch** : 터치센서를 테스트합니다.
  ...
  ![image-20210907144023124](.images/image-20210907144023124.png)
...
- **button** : 전원 버튼을 테스트합니다.
  ...
  ![image-20210907144318481](.images/image-20210907144318481.png)
...
- **dc** : 충전기 연결상태를 테스트합니다.
  ...
  ![image-20210907144633893](.images/image-20210907144633893.png)
...
- **battery** : 배터리를 테스트합니다.
  ...
  ![image-20210907144753187](.images/image-20210907144753187.png)
...
- **quit** : 테스트를 종료합니다.
  ...
  ![image-20210907150707394](.images/image-20210907150707394.png)
...
- 프로그램을 시작합니다.
  ...
  ![image-20210907151423678](.images/image-20210907151423678.png)
...
- 모션을 생성합니다.
  ...
  ![image-20210907151751536](.images/image-20210907151751536.png)
  ...
  - 시간을 설정하고 아래 저장 버튼을 누르면 오른쪽 테이블에 동작 하나가 추가됩니다.
    ...
    ![image-20210907155124034](.images/image-20210907155124034.png)
  
    
  
  - 동작테이블 각 행에 마우스를 올리면 빨간색으로 변하고, 클릭하면 해당 동작이 삭제됩니다.
  
    ![image-20210820111320876](.images/motioncreator.png)
  ...
  - 동작을 테스트하려면, 우측 상단의 `재생` 버튼을 누릅니다.
    ...
    ![image-20210907155722348](.images/image-20210907155722348.png)
  
    
  
  - 우측 하단 입력창에 모션 이름을 적고 `Export` 버튼을 누르면, 코드가 생성됩니다.
  
    ![image-20210907155919438](.images/image-20210907155919438.png)
  
    또한 `/motion-creator/` 경로에 `<모션 이름>.json` 의 이름으로도 저장된 것을 확인할 수 있습니다.
  
    ![image-20210907160525410](.images/image-20210907160525410.png)
  
    
  
  - 우측 상단의 `초기화` 버튼을 누르면, 기록했던 동작들이 모두 초기화됩니다.
  
    ![image-20210907160326781](.images/image-20210907160326781.png)
...
- 프로그램을 실행합니다.
  ...
  ![image-20210820112314329](.images/devicesimulator.png)

  

- 죄측 입력 바를 조작하여 **Neopixel** 을 제어할 수 있습니다.

  ![image-20210907162156112](.images/image-20210907162156112.png)

  ![image-20210907162233280](.images/image-20210907162233280.png)
