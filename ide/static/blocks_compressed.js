...
(function(root, factory) {
    ...
    var module$contents$Blockly$libraryBlocks$variablesDynamic_CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN = {
            customContextMenu: function(a) {
                if (!this.isInFlyout) {
                    ...
                    this.type || "variables_get_reporter_dynamic" === this.type) b = {
    ...
    var module$exports$Blockly$libraryBlocks$texts = {},
        ...
        module$contents$Blockly$libraryBlocks$texts_FieldDropdown = $.module$build$src$core$field_dropdown.FieldDropdown,
        module$contents$Blockly$libraryBlocks$texts_FieldImage = $.FieldImage$$module$build$src$core$field_image,
        module$contents$Blockly$libraryBlocks$texts_FieldTextInput = $.FieldTextInput$$module$build$src$core$field_textinput,
    ...
    module$exports$Blockly$libraryBlocks$texts.blocks.text_getSubstring = {
        init: function() {
            this.WHERE_OPTIONS_1 = [
                [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_GET_SUBSTRING_START_FROM_START, "FROM_START"],
                [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_GET_SUBSTRING_START_FROM_END, "FROM_END"],
                [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_GET_SUBSTRING_START_FIRST, "FIRST"]
            ];
        ...
        mutationToDom: function() {
            ...
            var b = this.getInput("AT1").type ===
                $.module$build$src$core$connection_type.ConnectionType.INPUT_VALUE;
        ...
        updateAt_: function(a, b) {
            ...
            b ? (this.appendValueInput("AT" + a).setCheck("Number"), module$contents$Blockly$libraryBlocks$texts_Msg.ORDINAL_NUMBER_SUFFIX &&
                this.appendDummyInput("ORDINAL" + a).appendField(module$contents$Blockly$libraryBlocks$texts_Msg.ORDINAL_NUMBER_SUFFIX)) : this.appendDummyInput("AT" + a);
            ...
            const c = new module$contents$Blockly$libraryBlocks$texts_FieldDropdown(this["WHERE_OPTIONS_" + a], function(d) {
                const e = "FROM_START" ===
                    d || "FROM_END" === d;
                if (e !== b) {
    ...
    module$exports$Blockly$libraryBlocks$texts.blocks.text_changeCase = {
        init: function() {
            const a = [
                [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE, "UPPERCASE"],
                [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_CHANGECASE_OPERATOR_LOWERCASE, "LOWERCASE"],
                [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE, "TITLECASE"]
            ];
            this.setHelpUrl(module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_CHANGECASE_HELPURL);
            this.setStyle("text_blocks");
            this.appendValueInput("TEXT").setCheck("String").appendField(new module$contents$Blockly$libraryBlocks$texts_FieldDropdown(a), "CASE");
            this.setOutput(!0, "String");
    ...
    module$exports$Blockly$libraryBlocks$texts.blocks.text_trim = {
        init: function() {
            const a = [
                [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_TRIM_OPERATOR_BOTH, "BOTH"],
                [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_TRIM_OPERATOR_LEFT, "LEFT"],
                [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_TRIM_OPERATOR_RIGHT, "RIGHT"]
            ];
            this.setHelpUrl(module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_TRIM_HELPURL);
            this.setStyle("text_blocks");
            this.appendValueInput("TEXT").setCheck("String").appendField(new module$contents$Blockly$libraryBlocks$texts_FieldDropdown(a),
                "MODE");
            this.setOutput(!0, "String");
    ...
    module$exports$Blockly$libraryBlocks$texts.blocks.text_prompt_ext = Object.assign({}, module$contents$Blockly$libraryBlocks$texts_TEXT_PROMPT_COMMON, {
        init: function() {
            var a = [
                [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_PROMPT_TYPE_TEXT, "TEXT"],
                [module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_PROMPT_TYPE_NUMBER, "NUMBER"]
            ];
            this.setHelpUrl(module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_PROMPT_HELPURL);
            this.setStyle("text_blocks");
            const b = this;
            a = new module$contents$Blockly$libraryBlocks$texts_FieldDropdown(a,
                function(c) {
                    b.updateType_(c)
                });
    ...
    module$exports$Blockly$libraryBlocks$texts.blocks.text_prompt = Object.assign({}, module$contents$Blockly$libraryBlocks$texts_TEXT_PROMPT_COMMON, {
        init: function() {
            ...
            this.setHelpUrl(module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_PROMPT_HELPURL);
            this.setStyle("text_blocks");
            a = new module$contents$Blockly$libraryBlocks$texts_FieldDropdown(a, function(c) {
                b.updateType_(c)
            });
            this.appendDummyInput().appendField(a, "TYPE").appendField(this.newQuote_(!0)).appendField(new $.FieldTextInput$$module$build$src$core$field_textinput(""), "TEXT").appendField(this.newQuote_(!1));
            this.setOutput(!0, "String");
            this.setTooltip(function() {
                return "TEXT" === b.getFieldValue("TYPE") ? module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_PROMPT_TOOLTIP_TEXT : module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_PROMPT_TOOLTIP_NUMBER
            })
    ...
    var module$contents$Blockly$libraryBlocks$texts_QUOTE_IMAGE_MIXIN = {
            ...
            newQuote_: function(a) {
                a = this.RTL ? !a : a;
                return new $.FieldImage$$module$build$src$core$field_image(a ? this.QUOTE_IMAGE_LEFT_DATAURI : this.QUOTE_IMAGE_RIGHT_DATAURI, this.QUOTE_IMAGE_WIDTH, this.QUOTE_IMAGE_HEIGHT,
                    a ? "\u201c" : "\u201d")
            }
        },
        ...
        module$contents$Blockly$libraryBlocks$texts_TEXT_JOIN_MUTATOR_MIXIN = {
            ...
            updateShape_: function() {
                ...
                for (var a = 0; a < this.itemCount_; a++)
                    ...
                    this.itemCount_; this.getInput("ADD" + a); a++) this.removeInput("ADD" + a)
            }
        },
    ...
    var module$contents$Blockly$libraryBlocks$texts_TEXT_INDEXOF_TOOLTIP_EXTENSION = function() {
        ...
        module$contents$Blockly$libraryBlocks$texts_TEXT_CHARAT_EXTENSION = function() {
            ...
            this.setTooltip(function() {
                ...
                ("FROM_START" === b || "FROM_END" === b) && (b = "FROM_START" === b ? module$contents$Blockly$libraryBlocks$texts_Msg.LISTS_INDEX_FROM_START_TOOLTIP :
                    module$contents$Blockly$libraryBlocks$texts_Msg.LISTS_INDEX_FROM_END_TOOLTIP) && (c += "  " + b.replace("%1", a.workspace.options.oneBasedIndex ? "#1" : "#0"));
                return c
            })
        };
    ...
    var module$exports$Blockly$libraryBlocks$procedures = {},
        ...
        module$contents$Blockly$libraryBlocks$procedures_FieldCheckbox = $.FieldCheckbox$$module$build$src$core$field_checkbox,
        module$contents$Blockly$libraryBlocks$procedures_FieldLabel =
        $.FieldLabel$$module$build$src$core$field_label,
        module$contents$Blockly$libraryBlocks$procedures_FieldTextInput = $.FieldTextInput$$module$build$src$core$field_textinput,
    ...
    var module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_DEF_COMMON = {
        ...
        updateParams_: function() {
            let a = "";
            this.arguments_.length && (a = module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_BEFORE_PARAMS +
        ...
        domToMutation: function(a) {
            ...
            for (let c = 0, d; d = a.childNodes[c]; c++)
                if ("arg" === d.nodeName.toLowerCase()) {
                    ...
                    null !==
                        b ? this.argumentVarModels_.push(b) : console.log(`Failed to create a variable named "${e}", ignoring.`)
                } this.updateParams_();
        ...
        compose: function(a) {
            ...
            if (null !== a && (a = "TRUE" === a, this.hasStatements_ !== a))
                if (a) this.setStatements_(!0), $.Mutator$$module$build$src$core$mutator.reconnect(this.statementConnection_,
        ...
        renameVarById: function(a, b) {
            ...
            if ("" === c.type) {
                ...
                var d = !1;
                for (let e = 0; e < this.argumentVarModels_.length; e++) this.argumentVarModels_[e].getId() ===
                    a && (this.arguments_[e] = b.name, this.argumentVarModels_[e] = b, d = !0);
            ...
            if (!this.isInFlyout) {
                ...
                if (!this.isCollapsed())
                    for (b = 0; b < this.argumentVarModels_.length; b++) d = {
                        enabled: !0
                    }, c = this.argumentVarModels_[b], d.text = module$contents$Blockly$libraryBlocks$procedures_Msg.VARIABLES_SET_CREATE_GET.replace("%1",
    ...
    module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_defnoreturn = Object.assign({}, module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_DEF_COMMON, {
        init: function() {
            ...
            a = new $.FieldTextInput$$module$build$src$core$field_textinput(a, $.module$build$src$core$procedures.rename);
            a.setSpellcheck(!1);
            this.appendDummyInput().appendField(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_DEFNORETURN_TITLE).appendField(a,
                "NAME").appendField("", "PARAMS");
    ...
    module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_defreturn = Object.assign({}, module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_DEF_COMMON, {
        init: function() {
            ...
            a = new $.FieldTextInput$$module$build$src$core$field_textinput(a, $.module$build$src$core$procedures.rename);
            a.setSpellcheck(!1);
            this.appendDummyInput().appendField(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_DEFRETURN_TITLE).appendField(a,
                "NAME").appendField("", "PARAMS");
            ...
            this.setMutator(new $.Mutator$$module$build$src$core$mutator(["procedures_mutatorarg"], this));
            (this.workspace.options.comments || this.workspace.options.parentWorkspace && this.workspace.options.parentWorkspace.options.comments) && module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_DEFRETURN_COMMENT &&
                this.setCommentText(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_DEFRETURN_COMMENT);
            this.setStyle("procedure_blocks");
    ...
    module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_mutatorcontainer = {
        init: function() {
            ...
            this.appendDummyInput("STATEMENT_INPUT").appendField(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_ALLOW_STATEMENTS).appendField(new $.FieldCheckbox$$module$build$src$core$field_checkbox("TRUE"), "STATEMENTS");
            this.setStyle("procedure_blocks");
    ...
    module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_mutatorarg = {
        init: function() {
            const a = new $.FieldTextInput$$module$build$src$core$field_textinput($.module$build$src$core$procedures.DEFAULT_ARG, this.validator_);
    ...
    var module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_CALL_COMMON = {
        ...
        setProcedureParameters_: function(a,
            b) {
            ...
            if (a.join("\n") === this.arguments_.join("\n")) this.quarkIds_ = b;
                ...
                this.updateShape_();
                if (this.quarkIds_ = b)
                    for (b = 0; b < this.arguments_.length; b++) a =
                        this.quarkIds_[b], a in this.quarkConnections_ && ($.Mutator$$module$build$src$core$mutator.reconnect(this.quarkConnections_[a], this, "ARG" + b) || delete this.quarkConnections_[a]);
        ...
        updateShape_: function() {
            for (var a = 0; a < this.arguments_.length; a++) {
                ...
                } else b = new $.FieldLabel$$module$build$src$core$field_label(this.arguments_[a]),
        ...
        onchange: function(a) {
            if (this.workspace && !this.workspace.isFlyout && a.recordUndo)
                if (a.type ===
                    $.module$build$src$core$events$events.BLOCK_CREATE && -1 !== a.ids.indexOf(this.id)) {
    ...
    module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_ifreturn = {
        ...
        onchange: function(a) {
            if (!(this.workspace.isDragging && this.workspace.isDragging() || a.type !== $.module$build$src$core$events$events.BLOCK_MOVE)) {
                ...
                b ? ("procedures_defnoreturn" === c.type && this.hasReturnValue_ ? (this.removeInput("VALUE"), this.appendDummyInput("VALUE").appendField(module$contents$Blockly$libraryBlocks$procedures_Msg.PROCEDURES_DEFRETURN_RETURN), this.hasReturnValue_ = !1) : "procedures_defreturn" !==
    ...
    var module$exports$Blockly$libraryBlocks$math = {},
        module$contents$Blockly$libraryBlocks$math_Extensions = $.module$build$src$core$extensions,
        module$contents$Blockly$libraryBlocks$math_FieldDropdown = $.module$build$src$core$field_dropdown,
        module$contents$Blockly$libraryBlocks$math_xmlUtils = $.module$build$src$core$utils$xml,
        module$contents$Blockly$libraryBlocks$math_BlockDefinition = Object,
        module$contents$Blockly$libraryBlocks$math_createBlockDefinitionsFromJsonArray = $.module$build$src$core$common.createBlockDefinitionsFromJsonArray,
        module$contents$Blockly$libraryBlocks$math_defineBlocks = $.module$build$src$core$common.defineBlocks;
    module$exports$Blockly$libraryBlocks$math.blocks = module$contents$Blockly$libraryBlocks$math_createBlockDefinitionsFromJsonArray([{
            type: "math_number",
            message0: "%1",
            args0: [{
                type: "field_number",
    ...
    $.module$build$src$core$extensions.register("math_op_tooltip", $.module$build$src$core$extensions.buildTooltipForDropdown("OP", module$contents$Blockly$libraryBlocks$math_TOOLTIPS_BY_OP));
    ...
    $.module$build$src$core$extensions.registerMutator("math_is_divisibleby_mutator", module$contents$Blockly$libraryBlocks$math_IS_DIVISIBLEBY_MUTATOR_MIXIN, module$contents$Blockly$libraryBlocks$math_IS_DIVISIBLE_MUTATOR_EXTENSION);
    ...
    $.module$build$src$core$extensions.registerMutator("math_modes_of_list_mutator", module$contents$Blockly$libraryBlocks$math_LIST_MODES_MUTATOR_MIXIN, module$contents$Blockly$libraryBlocks$math_LIST_MODES_MUTATOR_EXTENSION);
    module$contents$Blockly$libraryBlocks$math_defineBlocks(module$exports$Blockly$libraryBlocks$math.blocks);
    var module$exports$Blockly$libraryBlocks$loops = {},
        ...
        module$contents$Blockly$libraryBlocks$loops_BlockDefinition =
        Object,
    ...
    var module$contents$Blockly$libraryBlocks$logic_LOGIC_COMPARE_ONCHANGE_MIXIN = {
            onchange: function(a) {
                ...
                b && c && !this.workspace.connectionChecker.doTypeChecks(b.outputConnection, c.outputConnection) && ($.module$build$src$core$events$events.setGroup(a.group), a = this.prevBlocks_[0], a !== b && (b.unplug(), !a || a.isDisposed() || a.isShadow() || this.getInput("A").connection.connect(a.outputConnection)),
                    b = this.prevBlocks_[1], b !== c && (c.unplug(), !b || b.isDisposed() || b.isShadow() || this.getInput("B").connection.connect(b.outputConnection)), this.bumpNeighbours(), $.module$build$src$core$events$events.setGroup(!1));
    ...
    var module$contents$Blockly$libraryBlocks$logic_LOGIC_TERNARY_ONCHANGE_MIXIN = {
        ...
        onchange: function(a) {
            ...
            if ((b || c) && d)
                for (let e = 0; 2 > e; e++) {
                    const f = 1 === e ? b : c;
                    f && !f.workspace.connectionChecker.doTypeChecks(f.outputConnection, d) && ($.module$build$src$core$events$events.setGroup(a.group), d === this.prevParentConnection_ ? (this.unplug(), d.getSourceBlock().bumpNeighbours()) :
                        (f.unplug(), f.bumpNeighbours()), $.module$build$src$core$events$events.setGroup(!1))
                }
    ...
    var module$exports$Blockly$libraryBlocks$lists = {},
        ...
        module$contents$Blockly$libraryBlocks$lists_Xml = $.module$build$src$core$xml,
    ...
    module$exports$Blockly$libraryBlocks$lists.blocks.lists_create_with = {
        ...
        updateShape_: function() {
            ...
            for (var a = 0; a < this.itemCount_; a++)
                if (!this.getInput("ADD" + a)) {
                    const b = this.appendValueInput("ADD" +
                        a).setAlign($.Align$$module$build$src$core$input.RIGHT);
    ...
    module$exports$Blockly$libraryBlocks$lists.blocks.lists_indexOf = {
        init: function() {
            const a = [
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_INDEX_OF_FIRST, "FIRST"],
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_INDEX_OF_LAST, "LAST"]
            ];
            ...
            this.appendValueInput("FIND").appendField(new module$contents$Blockly$libraryBlocks$lists_FieldDropdown(a), "END");
            this.setInputsInline(!0);
            const b = this;
            this.setTooltip(function() {
    ...
    module$exports$Blockly$libraryBlocks$lists.blocks.lists_getIndex = {
        init: function() {
            var a = [
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_GET, "GET"],
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_GET_REMOVE, "GET_REMOVE"],
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_REMOVE, "REMOVE"]
            ];
            this.WHERE_OPTIONS = [
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_FROM_START, "FROM_START"],
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_FROM_END,
                    "FROM_END"
                ],
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_FIRST, "FIRST"],
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_LAST, "LAST"],
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_RANDOM, "RANDOM"]
            ];
            this.setHelpUrl(module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_HELPURL);
            this.setStyle("list_blocks");
            a = new module$contents$Blockly$libraryBlocks$lists_FieldDropdown(a, function(c) {
                c = "REMOVE" === c;
            ...
            this.setTooltip(function() {
                ...
                if ("FROM_START" === d || "FROM_END" ===
                    d) e += "  " + ("FROM_START" === d ? module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_INDEX_FROM_START_TOOLTIP : module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_INDEX_FROM_END_TOOLTIP).replace("%1", b.workspace.options.oneBasedIndex ? "#1" : "#0");
                return e
            })
        },
        mutationToDom: function() {
        ...
        loadExtraState: function(a) {
            a.isStatement ? this.updateStatement_(!0) : "string" === typeof a && this.domToMutation($.module$build$src$core$xml.textToDom(a))
        },
        updateStatement_: function(a) {
            a !== !this.outputConnection && (this.unplug(!0, !0), a ? (this.setOutput(!1),
                this.setPreviousStatement(!0), this.setNextStatement(!0)) : (this.setPreviousStatement(!1), this.setNextStatement(!1), this.setOutput(!0)))
        },
        updateAt_: function(a) {
            this.removeInput("AT");
            this.removeInput("ORDINAL", !0);
            ...
            const b = new module$contents$Blockly$libraryBlocks$lists_FieldDropdown(this.WHERE_OPTIONS,
                function(c) {
    ...
    module$exports$Blockly$libraryBlocks$lists.blocks.lists_setIndex = {
        init: function() {
            const a = [
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_SET_INDEX_SET, "SET"],
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_SET_INDEX_INSERT, "INSERT"]
            ];
            this.WHERE_OPTIONS = [
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_FROM_START, "FROM_START"],
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_INDEX_FROM_END, "FROM_END"],
            ...
            this.appendDummyInput().appendField(new module$contents$Blockly$libraryBlocks$lists_FieldDropdown(a),
            ...
            this.setTooltip(function() {
                ...
                if ("FROM_START" === d || "FROM_END" === d) e += "  " + module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_INDEX_FROM_START_TOOLTIP.replace("%1", b.workspace.options.oneBasedIndex ?
                    "#1" : "#0");
                return e
            })
        },
        ...
        updateAt_: function(a) {
            ...
            a ? (this.appendValueInput("AT").setCheck("Number"),
                module$contents$Blockly$libraryBlocks$lists_Msg.ORDINAL_NUMBER_SUFFIX && this.appendDummyInput("ORDINAL").appendField(module$contents$Blockly$libraryBlocks$lists_Msg.ORDINAL_NUMBER_SUFFIX)) : this.appendDummyInput("AT");
            const b = new module$contents$Blockly$libraryBlocks$lists_FieldDropdown(this.WHERE_OPTIONS, function(c) {
                const d = "FROM_START" === c || "FROM_END" === c;
                if (d !== a) {
                    const e = this.getSourceBlock();
                    e.updateAt_(d);
    ...
    module$exports$Blockly$libraryBlocks$lists.blocks.lists_getSublist = {
        init: function() {
            this.WHERE_OPTIONS_1 = [
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_SUBLIST_START_FROM_START, "FROM_START"],
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_SUBLIST_START_FROM_END, "FROM_END"],
                [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_SUBLIST_START_FIRST, "FIRST"]
            ];
            this.WHERE_OPTIONS_2 = [
            ...
            module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_SUBLIST_TAIL &&
                this.appendDummyInput("TAIL").appendField(module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_GET_SUBLIST_TAIL);
            this.setInputsInline(!0);
            this.setOutput(!0, "Array");
            this.updateAt_(1, !0);
            this.updateAt_(2, !0);
        ...
        updateAt_: function(a, b) {
            this.removeInput("AT" + a);
            this.removeInput("ORDINAL" + a, !0);
            b ? (this.appendValueInput("AT" + a).setCheck("Number"), module$contents$Blockly$libraryBlocks$lists_Msg.ORDINAL_NUMBER_SUFFIX &&
                this.appendDummyInput("ORDINAL" + a).appendField(module$contents$Blockly$libraryBlocks$lists_Msg.ORDINAL_NUMBER_SUFFIX)) : this.appendDummyInput("AT" + a);
            const c = new module$contents$Blockly$libraryBlocks$lists_FieldDropdown(this["WHERE_OPTIONS_" + a], function(d) {
    ...
    module$exports$Blockly$libraryBlocks$lists.blocks.lists_split = {
        init: function() {
            const a = this,
                b = new module$contents$Blockly$libraryBlocks$lists_FieldDropdown([
                    [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_SPLIT_LIST_FROM_TEXT, "SPLIT"],
                    [module$contents$Blockly$libraryBlocks$lists_Msg.LISTS_SPLIT_TEXT_FROM_LIST, "JOIN"]
                ], function(c) {
                    a.updateType_(c)
                });
    ...
    var module$exports$Blockly$libraryBlocks$colour = {},
        ...
        module$contents$Blockly$libraryBlocks$colour_createBlockDefinitionsFromJsonArray = $.module$build$src$core$common.createBlockDefinitionsFromJsonArray,
        module$contents$Blockly$libraryBlocks$colour_defineBlocks = $.module$build$src$core$common.defineBlocks;
    module$exports$Blockly$libraryBlocks$colour.blocks = module$contents$Blockly$libraryBlocks$colour_createBlockDefinitionsFromJsonArray([{
        type: "colour_picker",
        message0: "%1",
        args0: [{
            type: "field_colour",
    ...
    module$contents$Blockly$libraryBlocks$colour_defineBlocks(module$exports$Blockly$libraryBlocks$colour.blocks);
    var module$exports$Blockly$libraryBlocks = {},
        module$contents$Blockly$libraryBlocks_BlockDefinition = Object;
    module$exports$Blockly$libraryBlocks.colour = module$exports$Blockly$libraryBlocks$colour;
    ...
    module$exports$Blockly$libraryBlocks.math = module$exports$Blockly$libraryBlocks$math;
