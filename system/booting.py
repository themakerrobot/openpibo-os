...
if __name__ == "__main__":
  ...
  try:
    ...
    os.system('gpio mode 7 out;gpio write 7 1;/home/pi/openpibo/system/wifi-ap-sta start')
    ...
    for i in range(1,15):
      data = subprocess.check_output(['/home/pi/openpibo/system/get_network.sh']).decode('utf-8').strip('\n').split(',')
      if data[0] != '' or data[2] != '':
        break
